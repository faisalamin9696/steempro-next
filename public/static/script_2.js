(function () {
  ...
  k("Number.MAX_SAFE_INTEGER", function () {
  ...
  k("Number.isSafeInteger", function (a) {
    return a
      ? a
      : function (b) {
...
*/
  ...
  var w, x;
  a: {
    for (var ma = ["CLOSURE_FLAGS"], y = t, z = 0; z < ma.length; z++)
      if (((y = y[ma[z]]), null == y)) {
        x = null;
        break a;
      }
  ...
  var na = x && x[610401301];
  w = null != na ? na : !1;
  var A,
    oa = t.navigator;
  A = oa ? oa.userAgentData || null : null;
  function B(a) {
    return w
      ? A
  ...
  function C(a) {
    var b;
    a: {
      if ((b = t.navigator)) if ((b = b.userAgent)) break a;
      b = "";
    }
    return -1 != b.indexOf(a);
  }
  function D() {
    return w ? !!A && 0 < A.brands.length : !1;
  }
  function E() {
    return D()
      ? B("Chromium")
  ...
  function ta(a) {
    ...
    b &&
      ((c = m(ua(c, a))), (b = c.next().value), (a = c.next().value), (c = b));
    H = c >>> 0;
    I = a >>> 0;
  }
  function va(a, b) {
  ...
  var N = {},
    Ba = {};
  function Ca(a) {
    return !(!a || "object" !== typeof a || a.g !== Ba);
  }
  function Da(a) {
    return (
      null !== a &&
  ...
  function Ja(a, b, c, d, e) {
    ...
    d = d ? !!(f & 32) : void 0;
    a = Array.prototype.slice.call(a);
    for (var g = 0; g < a.length; g++) a[g] = Ia(a[g], b, c, d, e);
    c && c(f, a);
    return a;
  }
  function Ka(a) {
    return a.s === N ? a.toJSON() : Ga(a);
  }
  function La(a, b, c) {
    c = void 0 === c ? za : c;
    if (null != a) {
      ...
      if (Array.isArray(a)) {
        ...
        return b ? M(a, (d | 34) & -12293) : Ja(a, La, d & 4 ? za : c, !0, !0);
      }
      a.s === N &&
        ((c = a.h),
        (d = L(c)),
        (a = d & 2 ? a : Fa(a.constructor, Ma(c, d, !0))));
      return a;
    }
  }
  function Ma(a, b, c) {
  ...
  function Qa(a, b) {
    ...
    var f = L(e),
      g = Oa(e, f, b, d);
    if (null != g && "object" === typeof g && g.s === N) c = g;
    ...
    f & 2 ||
      ...
      (c = g.h),
      (h = L(c)),
      (g = h & 2 ? Fa(g.constructor, Ma(c, h, !1)) : g),
      g !== e && ((e = g), Pa(a, f, b, e, d)));
    return e;
  }
  function Sa(a, b) {
    a = Na(a, b);
  ...
  function Ta(a, b) {
    ...
    if (null != a)
      if (
        ((b = typeof a),
        "number" === b ? Number.isFinite(a) : "string" !== b ? 0 : Ea.test(a))
      )
        if ("number" === typeof a) {
            ...
            if (16 > a.length) ta(Number(a));
              ...
              for (var e = b, f = ((d - b) % 6) + b; f <= d; e = f, f += 6)
                (e = Number(a.slice(e, f))),
                  ...
                  (H = 1e6 * H + e),
                  4294967296 <= H &&
                    ((I += Math.trunc(H / 4294967296)), (I >>>= 0), (H >>>= 0));
              b &&
                ((b = m(ua(H, I))),
                (a = b.next().value),
                (b = b.next().value),
  ...
  T.prototype.toJSON = function () {
    return Ua(this, Ja(this.h, Ka, void 0, void 0, !1), !0);
  };
  T.prototype.s = N;
  T.prototype.toString = function () {
    return Ua(this, this.h, !1).toString();
  };
  function Ua(a, b, c) {
      ...
      a: {
        ...
        for (p in g)
          if (Object.prototype.hasOwnProperty.call(g, p)) {
            ...
            if (Array.isArray(u)) {
              var jb = u;
              if (P(u, d, +p) || (Ca(u) && 0 === u.size)) u = null;
              u != jb && (l = !0);
            }
            null != u ? (h[p] = u) : (l = !0);
          }
    ...
    for (p = +!!(e & 512) - 1; 0 < a; a--) {
      ...
      c = b[O];
      O -= p;
      if (!(null == c || P(c, d, O) || (Ca(c) && 0 === c.size))) break;
      var kb = !0;
    }
    if (!f && !kb) return b;
...
*/
  ...
  function mb(a) {
    ...
    b.style.backgroundColor = ob(249, 259, 242, 252, 219, 229);
    b.style.boxShadow = "0 0 12px #888";
    b.style.color = ob(0, 10, 0, 10, 0, 10);
  ...
  function pb(a) {
    for (var b = m(a.j), c = b.next(); !c.done; c = b.next())
  ...
  function yb(a, b) {
    this.m = a;
    this.o = new bb(a.document);
    this.g = b;
    this.j = S(this.g, 1);
    this.u = vb(Qa(this.g, 2)) || ub(wb);
    this.i = !1;
    b = vb(Qa(this.g, 13)) || ub(xb);
    this.l = new ib(a.document, b, S(this.g, 12));
  }
  ...
  function zb(a) {
    ...
    eb(
      ...
      function () {
        ...
        b ? Z(a, S(a.g, 14)) : (Z(a, S(a.g, 8)), lb(a.l));
      },
      function () {
        qb(
          function () {
  ...
  (function (a, b) {
    t[a] = function () {
      ...
      t[a] = function () {};
      b.call.apply(b, [null].concat(c instanceof Array ? c : fa(m(c))));
    };
  })("__h82AlnkH6D91__", function (a) {
    "function" === typeof window.atob &&
      new yb(window, tb(window.atob(a))).start();
  });
}).call(this);

window.__h82AlnkH6D91__(
  ""
);
