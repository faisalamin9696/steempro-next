  ...
  return (
    <main className="min-h-screen pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex flex-col justify-center min-h-[calc(100vh-64px)] py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            {/* Game Canvas - Order 1 on mobile, 2 on desktop */}
            <div className="flex flex-col items-center order-1 lg:order-2">
              <div className="w-full max-w-[450px] relative">
                <div className="absolute -inset-10 bg-amber-500/5 blur-[100px] rounded-full opacity-50 pointer-events-none" />
