        ...
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">Total {allRows?.length} {isFollowing ? 'Following' : 'Followers'}</span>
        ...
        <div>
            ...
            >
                ...
                <TableBody emptyContent={"No data found"}>
                    {sortedItems.slice((page - 1) * rowsPerPage, (page) * rowsPerPage)?.map((row) =>
                        <TableRow key={row}>
                            {(columnKey) => <TableCell>
