    ...
    return (
        <div className="flex items-center justify-center m-6 rounded-lg">
            ...
            <div className="no-file-found flex flex-col items-center justify-center py-8 px-4 text-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
                ...
                <div className="flex text-gray-500 dark:text-gray-400 mt-2 gap-1">
                    <p>No worries! Return to </p>
                    <Link className='text-blue-500' href={'/'}>homepage</Link>
                    <p> or explore some awesome posts. </p>
                </div>

                <ButtonGroup className='mt-4' radius='full' variant='flat'>
                    <Button as={Link} href='/trending'>Trending</Button>
                    <Button as={Link} href='/created'>New</Button>
                    <Button as={Link} href='/hot'>Hot</Button>
                </ButtonGroup>
            </div>
        </div>
    )
