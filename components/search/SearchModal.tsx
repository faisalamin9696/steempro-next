      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-muted">
            {t("reputation")}: {Math.floor(account.reputation)}
          </span>
            ...
            >
              <Tab
                ...
                title={
                  <div className="flex items-center space-x-2">
                    <User size={18} />
                    <span className="hidden xs:block">{t("accounts")}</span>
              ...
              <Tab
                ...
                title={
                  <div className="flex items-center space-x-2">
                    <FileText size={18} />
                    <span className="hidden xs:block">{t("posts")}</span>
              ...
              <Tab
                ...
                title={
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="hidden xs:block">{t("comments")}</span>
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 gap-1 animate-in fade-in slide-in-from-bottom-2 duration-500 p-1">
                  {activeTab === "accounts" &&
                    (results.accounts.length > 0 ? (
                      ...
                      <EmptyState text={t("noAccountsFound")} icon={User} />
                    ))}
                  {activeTab === "posts" &&
                    (results.posts.length > 0 ? (
                      <InfiniteList
                      ...
                      <EmptyState text={t("noPostsFound")} icon={FileText} />
                    ))}
                  {activeTab === "comments" &&
                    (results.comments.length > 0 ? (
                      <InfiniteList
                ...
                <div className="flex flex-col items-center justify-center gap-6 text-muted">
                  ...
                  <div className="flex flex-wrap gap-4 mt-4">
                    ...
                    >
                      {t("trySearch", { query: "steempro.com" })}
                    </div>
                    <div
                      className="px-3 py-1.5 rounded-xl border border-divider text-[10px] font-bold hover:bg-default-100 cursor-pointer"
                      onClick={() => {
                    ...
                    >
                      {t("trySearch", { query: '"Story" AND "Pakistan"' })}
                    </div>
                  </div>
                </div>
              )}
